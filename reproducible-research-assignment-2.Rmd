...
This list shows some good candidates for fixing up. We also see (in the case of `TSTM WIND 40` and `TSTM WIND 45` that this approach breaks down a bit - I was going to automatically fix the typos but now decided to just type the fixes out)
